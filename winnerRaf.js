...
// Example data
const customers = [
  { id: 1, name: "Amina", gender: "female", email: "amina@example.com", isSubscriber: true, totalSpent: 120, rewardCredit: 0 },
  { id: 2, name: "Ben", gender: "male", email: "ben@example.com", isSubscriber: false, totalSpent: 250, rewardCredit: 0 },
  { id: 3, name: "Joel", gender: "male", email: "joel@example.com", isSubscriber: true, totalSpent: 60, rewardCredit: 0 },
  { id: 4, name: "Dina", gender: "female", email: "dina@example.com", isSubscriber: true, totalSpent: 310, rewardCredit: 0 },
  { id: 5, name: "Alusine", gender: "male", email: "balusinea1990@gmail.com", isSubscriber: true, totalSpent: 150, rewardCredit: 0 },
  { id: 6, name: "Sarah", gender: "female", email: "sarah@example.com", isSubscriber: true, totalSpent: 200, rewardCredit: 0 },
];
...
console.log("Raffle Pool:", rafflePool.map((c) => c.name));
